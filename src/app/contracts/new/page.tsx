    ...
    <div className="max-w-2xl space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-400 mt-1">Registrar contrato LTR / MTR</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="card space-y-5">
        ...
        <div>
          <div className="flex items-center justify-between mb-1">
            <label className="text-sm text-gray-400">Inquilino</label>
            <button
              type="button"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div>
            <label className="block text-sm text-gray-400 mb-1">Depósito</label>
            <input
              type="number"
              step="0.01"
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <label htmlFor="deposit_paid" className="text-sm text-gray-400">
            Depósito pagado
          </label>
        </div>
