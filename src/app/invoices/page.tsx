...
export default function InvoicesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Mock mode banner — se muestra solo cuando NEXT_PUBLIC_SHOW_FACTURAPI_CTA=true.
          Hasta que el equipo confirme credenciales productivas mantenemos el banner oculto
          para no contaminar la UI del operador. */}
      {mockMode && process.env.NEXT_PUBLIC_SHOW_FACTURAPI_CTA === 'true' && (
