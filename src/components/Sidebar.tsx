...
import { Building2, FileText, CreditCard, LayoutDashboard, LogOut, Menu, X, Sun, Moon, DollarSign, Calculator, Wrench, CalendarDays, Users } from 'lucide-react'
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-gray-800 dark:border-gray-800 [html.light_&]:border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-gray-500 [html.light_&]:text-gray-500">v0.3.0 · ALM809P</p>
            </div>
          </div>
          <button
            onClick={() => setOpen(false)}
